...
INCS = -Os $(ARCH) -I${SYSROOT}/usr/include -I${SYSROOT}/usr/include/SDL2 -ffunction-sections -fdata-sections -Wall -fpermissive
LIBS = -L${SYSROOT}/usr/lib $(ARCH) -lSDL2_ttf  -lSDL2 -lmad -lfreetype -lbz2 -ljpeg -lpng -lz -lpthread -lm
#removed -lSDL2_image -lSDL2_mixer
EXT_FLAGS =
else
DEFS = -DLINUX -DUSE_SDL_RENDERER -DNDEBUG -DMIYOO
INCS = `sdl2-config --cflags` -fpermissive
LIBS = `sdl2-config --libs` -lSDL2_ttf -ljpeg -lpng -lz -lbz2 -lm
EXT_FLAGS = 
#-lSDL2_mixer 
 endif
